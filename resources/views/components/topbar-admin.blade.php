            ...
            <ul class="nav-right">
                        ...
                        @php
                            $notificaciones = auth()
                                ...
                                ->unreadNotifications->filter(
                                    fn($n) => $n->type === App\Notifications\NuevaVenta::class,
                                );
                        @endphp

                        <i id="iconoCampana"
                            class="bi bi-bell-fill {{ $notificaciones->count() ? 'text-danger' : '' }}"></i>
                ...
                <li class="user-profile header-notification">
                    ...
                    <a href="#!" class="waves-effect waves-light" style="text-decoration: none;">
                        <span>
                            {{ $user && $user->role === 1 ? 'Administrador' : 'Usuario' }}
                        </span>
            ...
            <script>
                document.addEventListener('DOMContentLoaded', function() {
                    ...
                    notificationList.addEventListener('click', function(e) {
                        ...
                        fetch(`/notificaciones/${notiId}/leer`, {
                                method: 'POST',
                                headers: {
