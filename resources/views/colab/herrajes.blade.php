                                    ...
                                    <div class="page-body">
                                        <div class="card">
                                            ...
                                            <div class="card-header d-flex justify-content-between align-items-center">
                                                <h5 class="mb-0">Consulta de productos: Herrajes</h5>

                                                <div class="d-flex gap-2 ms-auto">
                                                    <a href="{{ route('descargar.inventario.herrajes') }}"
                                                    ...
                                                    <tbody>
                                                        @foreach ($productos_herrajes as $producto_herrajes)
                                                            <tr>
                                                                ...
                                                                <td><img src="{{ asset($producto_herrajes->imagen) }}"
                                                                        alt=""
                                                                        style="width: 150px; height: 150px; object-fit: cover; border-radius: 8px; border: 1px solid #ccc;">
                                                                </td>
                                                                <td>
                                                                    {{ $producto_herrajes->stock_cantidad }} piezas</td>
                                                                <td>{{ $producto_herrajes->serie }}
                                                                </td>
                                                                <td>{{ $producto_herrajes->linea }}
                                                                </td>
                                                            </tr>
                                                        @endforeach
                                                    </tbody>
...
<script src="{{ asset('js/table_herrajes_colab.js') }}"></script>
