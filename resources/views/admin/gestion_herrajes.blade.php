...
<body>
    ...
    @if (session('message') === 'ok2')
        <script>
            Swal.fire({
                text: "Línea registrada exitosamente",
                icon: "success",
                confirmButtonColor: "#00532C",
                showConfirmButton: true
            });
                                    ...
                                    <div class="page-body">
                                        <div class="card">
                                            ...
                                            <div class="card-header d-flex justify-content-between align-items-center">
                                                <h5 class="mb-0">Gestión de materiales: Herrajes</h5>
                                            </div>

                                            <div class="card-body table-responsive">
                                                @foreach ($productos_herrajes->groupBy('id_linea') as $lineaId => $series)
                                                            ...
                                                            <div class="modal fade modal-dialog-scrollable"
                                                                ...
                                                                <div class="modal-dialog">
                                                                    <div class="modal-content">
                                                                        ...
                                                                        <form
                                                                            action="{{ route('gestion_herrajes_admin_create_serie') }}"
                                                                            method="POST">
                                                                            @csrf
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td>
                                                                                    <div
                                                                                        ...
                                                                                        <div class="modal fade modal-dialog-scrollable"
                                                                                            ...
                                                                                            <div class="modal-dialog">
                                                                                                <div
                                                                                                    ...
                                                                                                    <form
                                                                                                        action="{{ route('gestion_herrajes_admin_update_serie', $serie->id_serie) }}"
                                                                                                        method="POST">
                                                                                                        @csrf
                                                                                                        <div
                                                                                                            class="modal-body">
                                                                                        ...
                                                                                        {{-- Botón Eliminar --}}
                                                                                        <form
                                                                                            action="{{ route('gestion_herrajes_admin_delete_serie', $serie->id_serie) }}"
                                                                                            method="POST"
                                                                                            class="formEliminar_serie_herrajes">
                                                                                            @csrf
                                                                                            @method('DELETE')
                                                                                            <button type="submit"
                                                ...
                                                <div class="modal fade modal-dialog-scrollable" id="modalAddLinea"
                                                    ...
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            ...
                                                            <form
                                                                action="{{ route('gestion_herrajes_admin_create_linea') }}"
                                                                method="POST">
                                                                @csrf
                                                                <div class="modal-body">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <div class="d-flex align-items-center gap-2">
                                                                        <!-- Botón Eliminar -->
                                                                        <form
                                                                            action="{{ route('gestion_herrajes_admin_delete_linea', $linea->id) }}"
                                                                            method="POST"
                                                                            class="formEliminar_linea_herrajes">
                                                                            @csrf
                                                                            @method('DELETE')
                                                                            <button type="submit"
                                                                                class="btn btn-danger">
