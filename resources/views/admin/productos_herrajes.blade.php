                                    ...
                                    <div class="page-body">
                                        <div class="card">
                                            ...
                                            <div class="card-header d-flex justify-content-between align-items-center">
                                                <h5 class="mb-0">Gestión de productos: Herrajes</h5>

                                                <div class="d-flex gap-2 ms-auto">
                                                    <a href="{{ route('descargar.inventario.herrajes.admin') }}"
                                                    ...
                                                    <a href="{{ route('gestion_herrajes_admin_show') }}" target="_blank"
                                                ...
                                                <div class="modal fade modal-dialog-scrollable" id="modalAddProduct"
                                                    ...
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            ...
                                                            <form action="{{ route('herrajes_add_product') }}"
                                                                ...
                                                                <div class="modal-body">
                                                                    ...
                                                                    <div class="mb-3">
                                                                        ...
                                                                        <select name="linea" id="linea"
                                                                            ...
                                                                            @foreach ($lineas_herrajes as $lineas)
                                                                    ...
                                                                    <div class="mb-3">
                                                                        ...
                                                                        <select name="serie" id="serie"
                                                                            ...
                                                                            @foreach ($tipos_herrajes as $serie)
                                            ...
                                            <div class="row mb-4">
                                                <div class="col-md-4 ms-3">
                                                    ...
                                                    <select id="filtroLinea"
                                                        ...
                                                        @foreach ($tipos_herrajes->unique('linea') as $producto)
                                            ...
                                            <div class="card-body table-responsive">
                                                <table id="tabla_herrajes" class="tablas display">
                                                    <thead>
                                                        <tr>
                                                            <th>Código</th>
                                                            <th>Producto</th>
                                                    ...
                                                    <tbody>
                                                        @foreach ($productos_herrajes as $producto_herrajes)
                                                            <tr>
                                                                <td>{{ $producto_herrajes->codigo }}</td>
                                                                <td>{{ $producto_herrajes->producto }}
                                                                </td>
                                                                <td class="align-middle">
                                                                    <div class="d-flex align-items-center gap-2">
                                                                        <input type="text"
                                                                            class="form-control form-control-sm text-center input-stock"
                                                                            value="{{ $producto_herrajes->stock_cantidad }}"
                                                                            readonly>

                                                                        <button type="button"
                                                                            class="btn btn-sm btn-primary"
                                                                            data-bs-toggle="modal"
                                                                            data-bs-target="#modalStock_{{ $producto_herrajes->id }}">
                                                                            <i class="bi bi-arrow-clockwise"></i>
                                                                        </button>

                                                                        <div class="modal fade modal-dialog-scrollable"
                                                                            id="modalStock_{{ $producto_herrajes->id }}"
                                                                            ...
                                                                            <div class="modal-dialog">
                                                                                <div class="modal-content">
                                                                                    ...
                                                                                    <form
                                                                                        action="{{ route('herrajes_stock_product') }}"
                                                                                        method="POST">
                                                                                        @csrf
                                                                                        <div class="modal-body">
                                                                                            <input type="hidden"
                                                                                                value="{{ $producto_herrajes->id }}"
                                                                                                name="producto_id">
                                                                                            ...
                                                                                            <div class="mb-3">
                                                                                                ...
                                                                                                <input type="number"
                                                                                                    ...
                                                                                                    name="cantidad"
                                                                                                    class="form-control"
                                                                                                    value="{{ $producto_herrajes->stock_cantidad ?? 0 }}"
                                                                                                    min="0">
                                                                                            </div>
                                                                ...
                                                                <td>
                                                                    <div class="d-flex align-items-center">
                                                                        <button type="button"
                                                                            class="btn btn-secondary"
                                                                            data-bs-toggle="modal"
                                                                            data-bs-target="#modalEdit_{{ $producto_herrajes->id }}">
                                                                            <i class="bi bi-pencil-fill"></i>
                                                                        </button>
                                                                        <div class="modal fade modal-dialog-scrollable"
                                                                            id="modalEdit_{{ $producto_herrajes->id }}"
                                                                            data-bs-backdrop="static"
                                                                            data-bs-keyboard="false" tabindex="-1"
                                                                            ...
                                                                            <div class="modal-dialog">
                                                                                <div class="modal-content">
                                                                                    ...
                                                                                    <form
                                                                                        action="{{ route('herrajes_update_product') }}"
                                                                                        method="POST"
                                                                                        ...
                                                                                        <div class="modal-body">
                                                                                            ...
                                                                                            <div class="mb-3">
                                                                                                ...
                                                                                                <input type="text"
                                                                                                    ...
                                                                                                    name="codigo"
                                                                                                    class="form-control"
                                                                                                    value="{{ $producto_herrajes->codigo }}">
                                                                                            </div>
                                                                                            <div class="mb-3">
                                                                                                <label for="producto"
                                                                                                    class="form-label"><b>Producto</b></label>
                                                                                                <input type="text"
                                                                                                    ...
                                                                                                    name="producto"
                                                                                                    class="form-control"
                                                                                                    value="{{ $producto_herrajes->producto }}">
                                                                                            </div>
                                                                                            <div class="mb-3">
                                                                                                <label for="linea"
                                                                                                    class="form-label"><b>Línea</b></label>
                                                                                                <select name="linea"
                                                                                                    id="linea_update_{{ $producto_herrajes->id }}"
                                                                                                    class="form-select">
                                                                                                    <option
                                                                                                        value="{{ $producto_herrajes->id_linea }}"
                                                                                                        selected>
                                                                                                        Línea actual:
                                                                                                        {{ ucfirst(str_replace('Línea', '', $producto_herrajes->linea)) }}
                                                                                                    </option>
                                                                                            ...
                                                                                            <div class="mb-3">
                                                                                                <label for="serie"
                                                                                                    class="form-label"><b>Serie</b></label>
                                                                                                <select name="serie"
                                                                                                    id="serie_update_{{ $producto_herrajes->id }}"
                                                                                                    class="form-select">
                                                                                                    <option
                                                                                                        value="{{ $producto_herrajes->id_serie }}"
                                                                                                        selected>
                                                                                                        {{ $producto_herrajes->serie }}
                                                                                                    </option>
                                                                                                </select>
                                                                                            </div>
                                                                                            <div class="mb-3">
                                                                                                ...
                                                                                                @if ($producto_herrajes->imagen)
                                                                                                    <div
                                                                                                        class="mt-2">
                                                                                                        <img src="{{ asset($producto_herrajes->imagen) }}"
                                                                                                            alt="{{ $producto_herrajes->codigo . ' ' . $producto_herrajes->producto }}"
                                                                        ...
                                                                        <form
                                                                            action="{{ route('herrajes_delete_product', $producto_herrajes->id) }}"
                                                                ...
                                                                <td class="d-none">
                                                                    {{ $producto_herrajes->stock_cantidad }}</td>
                                                                <td class="d-none">{{ $producto_herrajes->serie }}
                                                                </td>
                                                                <td class="d-none">{{ $producto_herrajes->linea }}
                                                                </td>
                                                            </tr>
                                                        @endforeach
                                                    </tbody>
...
<script src="{{ asset('js/table_herrajes.js') }}"></script>
<script src="{{ asset('js/gestion_herrajes.js') }}"></script>
