...
<body>
    ...
    <h4 style="margin-bottom: 8px;">Resumen de Cotización</h4>
    <ul style="padding-left: 20px; margin: 0; font-size: 12px; line-height: 1.2;">
        ...
        <li style="margin-bottom: 4px;">
            <p style="margin: 0;"><strong>Fecha de cotización:</strong>
                {{ \Carbon\Carbon::parse($venta->fecha_cotizacion)->format('d/m/Y') }}</p>
        </li>
    </ul>
